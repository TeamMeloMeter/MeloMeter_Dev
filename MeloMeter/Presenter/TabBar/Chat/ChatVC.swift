...
//        }
        ...
        let message1 = MockMessage(text: "test Message1", user: self.mockUser, messageId: "test MId", date: Date())
        let message2 = MockMessage(text: "test Message2", user: self.mockUser2, messageId: "test MId", date: Date())
