...
class DisconnetView: UIView {
    ...
    private func disconnectConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            exView.heightAnchor.constraint(equalToConstant: 498),
            
            exLabel1.centerXAnchor.constraint(equalTo: exView.centerXAnchor),
            ...
            exLabel2.topAnchor.constraint(equalTo: lineView.bottomAnchor, constant: 23),
            
            exLabel3.leadingAnchor.constraint(equalTo: exView.leadingAnchor, constant: 23),
            exLabel3.topAnchor.constraint(equalTo: exLabel2.bottomAnchor, constant: 31),
