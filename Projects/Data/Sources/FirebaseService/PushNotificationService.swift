...
public final class PushNotificationService: PushNotificationServiceP {
    ...
    public func sendPushNotification(title: String, body: String, type: AlarmType) {
        let message = [
...
//              ]
    ...
    public func localPushNotification(title: String, body: String) {
    ...
    public func addAlarm(text: String, date: String, type: String) -> Void {
    ...
    public func addRepeatAlarm(_ dataArray: [DdayCellData],_ firstDay: Date) {
    ...
    public func compareDates(date: Date) -> Bool {
        let calendar = Calendar.current
    ...
    public func setupAppStateNotifications() {
