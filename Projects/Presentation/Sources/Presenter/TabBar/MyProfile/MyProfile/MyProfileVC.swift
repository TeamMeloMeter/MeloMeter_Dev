...
public class MyProfileVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    public let phoneNumLabel: UILabel = {
        let label = UILabel()
    ...
    public let stateMessageLabel: UILabel = {
        let label = UILabel()
    ...
    public let profileEditButton: UIButton = {
        let button = UIButton()
    ...
    public let alarmTitleLabel: UILabel = {
        let label = UILabel()
    ...
    public let alarmSubtitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray1
        label.font = FontManager.shared.medium(ofSize: 14)
    ...
    public let alarmImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let dDayTitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray2
        label.font = FontManager.shared.medium(ofSize: 13)
        return label
    ...
    public let dDaySubtitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray1
        label.font = FontManager.shared.medium(ofSize: 14)
        label.text = "기념일"
    ...
    public let dDayImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let hundredQnATitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray2
        label.font = FontManager.shared.medium(ofSize: 13)
        label.text = "백문백답"
    ...
    public let hundredQnASubtitleLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray1
        label.font = FontManager.shared.medium(ofSize: 14)
    ...
    public let hundredQnAImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let noticeImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let noticeTextLabel: UILabel = {
        let label = UILabel()
        label.textColor = .gray1
    ...
    public let noticeArrowImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let qnAImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let qnAArrowImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "arrowIcon")
        imageView.contentMode = .right
        imageView.layer.borderColor = UIColor.clear.cgColor
    ...
    public let infoImageView: UIImageView = {
        let imageView = UIImageView()
    ...
    public let infoArrowImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "arrowIcon")
        imageView.contentMode = .right
        imageView.layer.borderColor = UIColor.clear.cgColor
