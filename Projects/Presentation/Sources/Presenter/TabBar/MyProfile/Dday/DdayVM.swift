...
public class DdayVM {
    ...
    public struct AddDdayInput {
        let xBtnTapEvent: Observable<Void>
        let addDday: Observable<[String]>
    }
    
    public init(coordinator: DdayCoordinator, dDayUseCase: DdayUseCase) {
    ...
    public func focusCell(_ cellData: [DdayCell]) -> Single<IndexPath> {
    ...
    public func addDdayBinding(input: AddDdayInput, disposeBag: DisposeBag) {
