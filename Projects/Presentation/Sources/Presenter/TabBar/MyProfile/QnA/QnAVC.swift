...
public class QnAVC: UIViewController {
    
    private let viewModel: QnAVM?
    private let disposeBag = DisposeBag()
    private var radioBtnArray: [UIButton] = []
    public var selectedRadioBtn = BehaviorRelay<QnARadioBtn>(value: .auth)
    public var cellData: [String] = []
    public var selectedCellIndex = PublishRelay<(QnARadioBtn, Int)>()

    public init(viewModel: QnAVM) {
    ...
    // MARK: Event
    public func radioBtnTapped(_ sender: UIButton) {
    ...
    // 질문 tableView
    public let qnATableView: UITableView = {
