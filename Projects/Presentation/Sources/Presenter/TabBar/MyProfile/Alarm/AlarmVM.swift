...
public class AlarmVM {
    ...
    public init(coordinator: AlarmCoordinator, alarmUseCase: AlarmUseCase) {
    ...
    public func convertAlarmData(alarmModelList: [AlarmModel]) -> [AlarmData] {
    ...
    public func daysPassedSinceDate(_ inputDate: Date) -> Int {
