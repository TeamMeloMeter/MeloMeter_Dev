...
public class NoticeVC: UIViewController {
    
    private let viewModel: NoticeVM?
    private let disposeBag = DisposeBag()
    public var selectedCellIndex = PublishSubject<Int>()
    
    public init(viewModel: NoticeVM) {
    ...
    // MARK: UI
    public let noticeTableView: UITableView = {
