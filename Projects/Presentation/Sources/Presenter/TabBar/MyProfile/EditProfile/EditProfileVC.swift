...
public class EditProfileVC: UIViewController {
    ...
    public init(viewModel: EditProfileVM) {
    ...
    public func imageUploadErrorAlert() {
    ...
    public let userStateMessageLabel: UILabel = {
        let label = UILabel()
        label.text = ""
        label.font = FontManager.shared.medium(ofSize: 14)
        label.textColor = .gray1
    ...
    public let userGenderLabel: UILabel = {
        let label = UILabel()
        label.text = ""
        label.font = FontManager.shared.medium(ofSize: 14)
        label.textColor = .gray1
    ...
    public let disconnectLabel: UILabel = {
        let label = UILabel()
