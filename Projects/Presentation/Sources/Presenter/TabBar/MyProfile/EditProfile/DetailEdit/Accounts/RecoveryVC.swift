...
public class RecoveryVC: UIViewController {
    ...
    public var disconnectDate: String
    public var deadlineDate: String
    public var userName: String
    public var otherUserName: String
    
    public init(viewModel: AccountsVM, date: (String, String), names: (String, String)) {
...
"""
    ...
    // MARK: Event
    public func recoveryErrorAlert() {
...
""")
    ...
    public let recoveryBtn: UIButton = {
        let button = UIButton()
