...
public class HundredQAVC: UIViewController {
    ...
    public var selectedCellIndex = PublishSubject<(Int, String)>()
    public var questionTopData: [String] = []
    public var questionBottomData: [String] = []
    public var questionNumbers: [[String]] = []
    
    public init(viewModel: HundredQAVM) {
    ...
    public let questionCountLabel: UILabel = {
        let label = UILabel()
    ...
    public let ourHundredQALabel: UILabel = {
        let label = UILabel()
        label.text = "우리의 백문백답"
        label.font = FontManager.shared.semiBold(ofSize: 16)
        label.textColor = .gray1
