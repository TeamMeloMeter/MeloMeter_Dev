...
public class innerPictureView: UIView {
...
public class BottomSheetSmallView: UIView {
    ...
    public func configurePickedModel(pickedModel: SearchedModel) {
    ...
    public func configureCouplePlaceModel(placeModel: CouplePlaceModel) {
    ...
    public let catrgoryLabel = UILabel().then {
    ...
    public let rightBtn = UIImageView().then {
        $0.tintColor = .black
        $0.contentMode = .scaleAspectFill
    }
    public let locationNameLabel = UILabel().then {
        $0.font = FontManager.shared.bold(ofSize: 18)
    }
    public let locationLabel = UILabel().then {
        $0.font = FontManager.shared.medium(ofSize: 16)
        $0.textColor = .lightGray
        $0.numberOfLines = 2
    }
    public let dropPickerView = DropPickerView().then {
        $0.isHidden = true
    }
...
public class BottomSheetLargeView: UIView {
    ...
    public let largeLocationTF = UITextField().then  {
        $0.backgroundColor = .gray5
        $0.layer.cornerRadius = 8
        $0.placeholder = "장소 이름"
    }
    public let largeMemoTF = UITextField().then  {
        $0.backgroundColor = .gray5
        $0.layer.cornerRadius = 8
        $0.placeholder = "장소에 대한 짧은 메모를 남겨주세요."
    }
    public let largeCategoryStack = UIStackView().then {
        $0.distribution = .fillEqually
        $0.spacing = 10
        $0.axis = .horizontal
        $0.alignment = .fill
    }
    public var largePictureStack = UIStackView().then {
        $0.alignment = .center
        $0.spacing = 14
        $0.axis = .horizontal
        $0.distribution = .fillEqually
    }
    public var largeSaveBtn = UIButton().then {
...
public class BottomSheetinformView: UIView {
    ...
    public let informSmallView = BottomSheetSmallView()
    
    public func configure(placeModel: CouplePlaceModel, imageExist: Bool) {
        var imageViewH = 12
        if imageExist {
...
public class DropPickerView: UIView {
    
    public let edit = UILabel().then { $0.text = "수정"; $0.font = FontManager.shared.medium(ofSize: 15)}
    public let delete = UILabel().then { $0.text = "삭제";  $0.font = FontManager.shared.medium(ofSize: 15)}
