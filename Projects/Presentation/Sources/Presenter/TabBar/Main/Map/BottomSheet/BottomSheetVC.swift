...
public class BottomSheetVC: UIViewController {
    ...
    public let smallView = BottomSheetSmallView()
    public let largeView = BottomSheetLargeView().then {
        $0.isHidden = true
    }
    public let grabbar = UIImageView(image: UIImage(named: "grabbar"))
    ...
    public func setSmallView(pickedModel: SearchedModel) {
    ...
    public func setInformView(placeModel: CouplePlaceModel, imageExist: Bool) {
        self.largeView.isHidden = true
