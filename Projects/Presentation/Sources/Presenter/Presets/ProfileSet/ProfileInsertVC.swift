...
public final class ProfileInsertVC: UIViewController {
    ...
    //텍스트필드 유효입력 확인
    public var checkTextField : [Bool] = Array(repeating: false, count: 3)
    
    public var activeTextField: UITextField? = nil
    
    //키보드 알림 등록 객체 생성
    public let keyboardDetector = KeyboardStatusDetector()
    
    public init(viewModel: ProfileInsertVM) {
    ...
    // MARK: - Event
    public func handleKeyboardStatusChange(_ isKeyboardShown: [Any]) {
