...
public final class CoupleCombineVC: UIViewController {
    ...
    //내 코드 표시
    public let myCodeLabel: UILabel = {
        let label = UILabel()
        label.text = ""
        label.textColor = .gray1
    ...
    public let lineView1: UIView = UIView(frame: CGRect(x: 0, y: 0, width: 343, height: 1.5))
    
    public let shareBtn: UIButton = {
        let button = UIButton()
