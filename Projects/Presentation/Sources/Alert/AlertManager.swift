...
public final class AlertManager {
    ...
    public func setTitle(_ title: String) -> AlertManager {
        alertTitle = title
        return self
    }
    
    public func setMessage(_ text: String) -> AlertManager {
        message = text
        return self
    }
    
    public func addActionConfirm(_ text: String, action: (() -> Void)? = nil) -> AlertManager {
        addActionConfirm = AddAction(text: text, action: action)
        return self
    }
    
    @discardableResult
    public func showCustomAlert() -> Self {
    ...
    public func showNomalAlert(title: String, message: String) -> Single<Void> {
    ...
    public func showYNAlert() -> Single<Void> {
    ...
    public func showRequestLocationServiceAlert() -> Single<Bool> {
        return Single.create { single in
    ...
    public func showGenderAlert() -> Single<GenderType> {
        return Single.create { single in
...
extension AlertManager {
    ...
    public static func showNotExist(
        style: UIAlertController.Style,
        title: String?,
        message: String?
    )
