...
public class AccountsUseCase {
    ...
    public required init(userRepository: UserRepositoryP, coupleRepository: CoupleRepositoryP) {
        self.userRepository = userRepository
        self.coupleRepository = coupleRepository
        self.disposeBag = DisposeBag()
    }
    
    public func excuteDisconnect() -> Single<[String: String]> {
    ...
    public func excuteWithdrawal() -> Single<Bool> {
    ...
    public func excuteChangeAccessLevel() -> Single<Bool> {
