...
public class DdayUseCase {
    ...
    public var firstDay: PublishSubject<Date>
    public var dDayCellArray: PublishSubject<[DdayCellData]>
    
    public init(coupleRepository: CoupleRepositoryP) {
    ...
    public func sinceDday(from date: Date) -> Int {
    ...
    public func coupleObserverExcute() {
    ...
    public func createDdayList(_ dataArray: [DdayCellData],_ firstDay: Date) -> [DdayCellData] {
    ...
    public func addDday(add: [String]) -> Single<Void> {
        var data = add
