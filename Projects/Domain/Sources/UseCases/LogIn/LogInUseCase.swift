...
public class LogInUseCase {
    ...
    public var accessLevel: PublishRelay<AccessLevel>
    
    // MARK: Initializers
    public init(logInRepository: LogInRepositoryP, userRepository: UserRepositoryP) {
    ...
    public func sendNumberService(text: String?) -> Single<Void> {
    ...
    //로그인 요청 서비스
    public func inputVerificationCodeService(code: String?) -> Single<String?> {
    ...
    // 초대코드 발급 요청
    public func inviteCodeRequest() -> Single<LogInModel> {
    ...
    //커플 연결 서비스
    public func combineCoupleService(_ coupleCode: String?) -> Single<Void> {
        return Single<Void>.create { [weak self] single in
    ...
    public func combineCheckObserver() {
